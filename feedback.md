...
<span class="font-ultra-light">
	...
	<br><br>For Colombians we can also arrange some discounts. Please refer to <a class="text-rosybrown" href="https://www.ikkonos.com/ideate/cuanto-debe-cobrar-por-una-pagina-web-en-colombia-si-es-freelancer" target="_blank">      this article</a> in Spanish, which shows how a <i class="text-italic">custom website</i> with not too many features, will cost around USD $1,000 (COP $3'200,000), without too many complex customization or features.
</span>
