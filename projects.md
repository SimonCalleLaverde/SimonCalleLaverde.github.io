...
Most of the projects displayed between 2015 to 2019 are those which I worked as a team and mostly in the development phase starting from a base design I used to receive and a base template that we iterated on, and worked at the time over half or most of the development phase. Some sites may have new changes or additions by Code Nation's team in terms of UI or by the clients themselves through their CMS in terms of content through the years.
...
I'm now very passionate in interactive and digital design to bring live to brands through awesome sites that break the common rules of the web and let them communicate exactly what they want, with hand-crafted designs and great user experience. I started with a course in Web Design and Design for Mobile Devices 7 years ago, after a bachelor's degree as a Publicist.
