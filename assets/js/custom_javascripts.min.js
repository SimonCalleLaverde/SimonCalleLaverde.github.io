$(document).ready(function(){$("html, body").scrollTop(0);$(window).on("load",function(){setTimeout(function(){$("html, body").scrollTop(0)},0)})});$(function(){$(".smoothScroll").click(function(a){a.preventDefault();a=$(this.hash).offset()?$(this.hash).offset().top:10;$("html, body").animate({scrollTop:a-0},1200)})});$(function(){$(".switch-theme-colour").on("click",function(a){$("body").toggleClass("black white");$(".text-element").toggleClass("d-none d-inline-block");a.preventDefault()})});
...
var tlMwT=new TimelineMax,tlCd=new TimelineMax,tlSc=new TimelineMax,tlAp=new TimelineMax,tlSh=new TimelineMax,tlSl1=new TimelineMax,tlSl2=new TimelineMax,tlSl3=new TimelineMax,controller=new ScrollMagic.Controller;tlMwT.from(".gsap-my-work-title",2,{y:250,opacity:0,transformStyle:"preserve-3d",skewY:15,ease:Power3.easeOut});tlCd.from(".gsap-content-development",2,{y:250,opacity:0,transformStyle:"preserve-3d",skewY:15,ease:Power3.easeOut});
tlSc.from(".gsap-subcontent",2,{y:250,opacity:0,transformStyle:"preserve-3d",skewY:15,ease:Power3.easeOut});tlAp.from(".gsap-all-projects",2,{y:250,opacity:0,transformStyle:"preserve-3d",skewY:15,ease:Power3.easeOut});tlSh.from(".gsap-skills-headline",2,{y:250,opacity:0,transformStyle:"preserve-3d",skewY:15,ease:Power3.easeOut});tlSl1.from(".gsap-skills-list-1",2,{y:250,opacity:0,transformStyle:"preserve-3d",skewY:15,ease:Power3.easeOut});
tlSl2.from(".gsap-skills-list-2",2,{y:250,opacity:0,transformStyle:"preserve-3d",skewY:15,ease:Power3.easeOut});tlSl3.from(".gsap-skills-list-3",2,{y:250,opacity:0,transformStyle:"preserve-3d",skewY:15,ease:Power3.easeOut});
...
$(".burger-menu").mouseenter(function(a){TweenMax.to(this,.3,{transformOrigin:"0 0",scale:1});TweenMax.to(".burger-circle",.3,{scale:1.3})});$(".burger-menu").mousemove(function(a){callParallax(a)});function callParallax(a){parallaxIt(a,".burger-circle",60);parallaxIt(a,".burger-center",40)}
