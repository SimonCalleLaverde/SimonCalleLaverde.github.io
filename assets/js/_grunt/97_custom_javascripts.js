...
// // Init Rellax
// $(window).ready(function() {//$(document).ready(function() {//onload//$(function() {
...
var $jscomp=$jscomp||{};$jscomp.scope={};$jscomp.createTemplateTagFirstArg=function(a){return a.raw=a};$jscomp.createTemplateTagFirstArgWithRaw=function(a,c){a.raw=c;return a};$(window).ready(function(){new Rellax(".rellax",{center:!0})});$(window).ready(function(){lax.setup({breakpoints:{xs:0,sm:576,md:768,lg:992,xl:1200}});var a=function(){lax.update(window.scrollY);window.requestAnimationFrame(a)};window.requestAnimationFrame(a)});
...
a(window).resize(function(){c()});c()});jQuery(document).ready(function(a){var c=function(){var d=document.body.clientWidth;768>d?(a(".rolly-on-off").removeAttr("id"),a("body").addClass("theme-dark-mobile-wide")):768<=d&&(a(".rolly-on-off").attr("id","rolly"),a("body").removeClass("theme-dark-mobile-wide"))};a(window).resize(function(){c()});c()});$(function(){$(".column-div").columnize({columns:2})});
"addEventListener"in document&&document.addEventListener("DOMContentLoaded",function(){FastClick.attach(document.body)},!1);$(document).ready(function(){$("html, body").scrollTop(0);$(window).on("load",function(){setTimeout(function(){$("html, body").scrollTop(0)},0)})});
